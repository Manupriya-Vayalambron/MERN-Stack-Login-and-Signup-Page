...
const UserProfile = () => {
  ...
  const settingsItems = [
    {
      ...
      title: language === 'en' ? 'Saved Bus Stops' : 'സേവ് ചെയ്ത ബസ് സ്റ്റോപ്പുകൾ',
      link: '/saved-stops'
    },
    {
      icon: (
      ...
      title: language === 'en' ? 'Saved Routes' : 'സേവ് ചെയ്ത റൂട്ടുകൾ',
      link: '/saved-routes'
    },
    {
      icon: (
      ...
      title: language === 'en' ? 'Language' : 'ഭാഷ',
      extra: language === 'en' ? 'English' : 'മലയാളം',
      link: '/user-profile'
    },
    {
      icon: (
      ...
      title: language === 'en' ? 'Manage Settings' : 'ക്രമീകരണങ്ങൾ നിയന്ത്രിക്കുക',
      link: '/settings'
    },
    {
      icon: (
      ...
      title: language === 'en' ? 'Help & Support' : 'സഹായവും പിന്തുണയും',
      link: '/support'
    }
  ];
  ...
  const paymentItems = [
    ...
    },
    {
      ...
      title: language === 'en' ? 'Cards' : 'കാർഡുകൾ',
      link: '/cards'
    }
  ];
  ...
  const preferencesItems = [
    {
      ...
      title: language === 'en' ? 'Addresses' : 'വിലാസങ്ങൾ',
      link: '/addresses'
    },
    {
      icon: (
      ...
      title: language === 'en' ? 'Kiosk Preferences' : 'കിയോസ്ക് മുൻഗണനകൾ',
  ...
  return (
    <div className="main-wrapper bg-background-light dark:bg-background-dark text-gray-800 dark:text-gray-200">
      <header className="header sticky top-0 z-10 bg-background-light/80 dark:bg-background-dark/80 backdrop-blur-sm flex justify-between items-center px-4">
      ...
      <main className="flex-grow p-4 space-y-8">
        ...
        <div className="profile-sections">
          <div className="profile-section">
            <h2 className="section-title-profile">{language === 'en' ? 'Settings' : 'ക്രമീകരണങ്ങൾ'}</h2>
          ...
          <div className="profile-section">
            <h2 className="section-title-profile">{language === 'en' ? 'Payment' : 'പേയ്മെന്റ്'}</h2>
            <div className="settings-card">
          ...
          <div className="profile-section">
            <h2 className="section-title-profile">{language === 'en' ? 'Preferences' : 'മുൻഗണനകൾ'}</h2>
            <div className="settings-card">
      ...
      <footer className="footer-nav-container">
        <nav className="footer-nav-inner">
          <Link className="footer-nav-item" to="/yathrika-home">
            ...
            <span className="footer-nav-text">{language === 'en' ? 'Home' : 'ഹോം'}</span>
          </Link>
          <Link className="footer-nav-item" to="/order-history">
            ...
            <span className="footer-nav-text">{language === 'en' ? 'Orders' : 'ഓർഡറുകൾ'}</span>
          </Link>
          <Link className="footer-profile-active" to="/user-profile">
            ...
            <span className="footer-profile-label">{language === 'en' ? 'Profile' : 'പ്രൊഫൈൽ'}</span>
          </Link>
          <Link className="footer-nav-item" to="/notifications">
            <svg className="footer-nav-icon" fill="currentColor" height="24px" viewBox="0 0 256 256" width="24px" xmlns="http://www.w3.org/2000/svg">
              <path d="M221.8,175.94C216.25,166.38,208,139.33,208,104a80,80,0,1,0-160,0c0,35.34-8.26,62.38-13.81,71.94A16,16,0,0,0,48,200H88.81a40,40,0,0,0,78.38,0H208a16,16,0,0,0,13.8-24.06ZM128,216a24,24,0,0,1-22.62-16h45.24A24,24,0,0,1,128,216ZM48,184c7.7-13.24,16-43.92,16-80a64,64,0,1,1,128,0c0,36.05,8.28,66.73,16,80Z"></path>
            </svg>
            <span className="footer-nav-text">{language === 'en' ? 'Notifications' : 'അറിയിപ്പുകൾ'}</span>
          </Link>
        </nav>

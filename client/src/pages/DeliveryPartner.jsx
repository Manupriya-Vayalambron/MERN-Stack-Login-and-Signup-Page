...
const DeliveryPartnerDashboard = () => {
  ...
  const handleOrderUpdate = (data) => {
    if (data.type === 'new_order') {
      ...
      setAvailableOrders(prev => prev.filter(o => (o.orderId || o.id) !== data.orderId));
    }
  };
  ...
  const handleOrderStatusUpdate = ({ orderId, status }) =>
    setAcceptedOrders(prev => prev.map(o => (o.orderId || o.id) === orderId ? { ...o, status } : o));
        ...
        <main className="partner-dashboard-main">
          ...
          <section className="partner-section">
            <div className="partner-section-header">
              ...
              <button onClick={() => partner && loadAvailableOrders(partner.assignedBusStop)} className="partner-refresh-button">
            ...
            {availableOrders.length === 0 ? (
              ...
              <div className="partner-orders-grid">
                {availableOrders.map(order => (
                  <div key={order.orderId || order.id} className="partner-order-card available">

        ...
        <main>
          <div className="search-container">
            <div className="search-wrapper">
              <input 
                ...
                placeholder={language === 'en' ? "Search for items..." : "പദാർത്ഥങ്ങൾക്കായി തിരയുക..."} 
                type="text"
              />
          ...
          <div className="category-grid">
            <Link to="/products?category=food" className="category-item">
              ...
              <h2 className="category-title">{language === 'en' ? 'Food' : 'ഭക്ഷണം'}</h2>
            </Link>
            ...
            <Link to="/products?category=groceries" className="category-item">
              ...
              <h2 className="category-title">{language === 'en' ? 'Groceries' : 'പലചരക്ക്'}</h2>
            </Link>
            
            <Link to="/products?category=medicines" className="category-item">
              <img alt="Medicines" className="category-icon" src="https://media.istockphoto.com/id/1778918997/photo/background-of-a-large-group-of-assorted-capsules-pills-and-blisters.jpg?s=612x612&w=0&k=20&c=G6aeWKN1kHyaTxiNdToVW8_xGY0hcenWYIjjG_xwF_Q="/>
              <h2 className="category-title">{language === 'en' ? 'Medicines' : 'മരുന്നുകൾ'}</h2>
            </Link>
            ...
            <Link to="/products?category=essentials" className="category-item">
              ...
              <h2 className="category-title">{language === 'en' ? 'Essentials' : 'അത്യാവശ്യങ്ങൾ'}</h2>
            </Link>
          </div>

          <div className="section-header">
            <h2 className="section-title">{language === 'en' ? 'Next Bus Stop & Halt Countdown' : 'അടുത്ത ബസ് സ്റ്റോപ്പ് & ഹാൾട്ട് കൗണ്ട്ഡൗൺ'}</h2>
          </div>

          <div className="bus-countdown">
            <div className="bus-info">
              <div className="bus-details">
                <p className="bus-stop-number">{language === 'en' ? 'Stop 3' : 'സ്റ്റോപ്പ് 3'}</p>
                <p className="bus-stop-name">{language === 'en' ? 'Kochi Metro Station' : 'കൊച്ചി മെട്രോ സ്റ്റേഷൻ'}</p>
                <p className="bus-halt-time">{language === 'en' ? 'Halt Time: 2 minutes' : 'വിശ്രമ സമയം: 2 മിനിറ്റ്'}</p>
              </div>
          ...
          <div className="countdown-timer">
            <div className="timer-item">
              ...
              <p className="timer-label">{language === 'en' ? 'Minutes' : 'മിനിറ്റുകൾ'}</p>
            </div>
            <div className="timer-item">
              <div className="timer-value">30</div>
              <p className="timer-label">{language === 'en' ? 'Seconds' : 'സെക്കൻഡുകൾ'}</p>
            </div>
          </div>

          <div className="section-header">
            <h2 className="section-title">{language === 'en' ? 'Featured Offers' : 'പ്രധാന ഓഫറുകൾ'}</h2>
          </div>
          ...
          <div className="featured-offers">
            <div className="offers-container">
              <div className="offer-card">
                ...
                <p className="offer-text">{language === 'en' ? '20% off on first order' : 'ആദ്യ ഓർഡറിന് 20% കിഴിവ്'}</p>
              </div>
              <div className="offer-card">
                ...
                <p className="offer-text">{language === 'en' ? 'Free delivery on groceries' : 'പലചരക്ക് സാധനങ്ങൾക്ക് സൗജന്യ ഡെലിവറി'}</p>
              </div>
              <div className="offer-card">
                ...
                <p className="offer-text">{language === 'en' ? 'Special discounts on medicines' : 'മരുന്നുകൾക്ക് പ്രത്യേക കിഴിവുകൾ'}</p>
              </div>
            </div>
          </div>
        </main>
